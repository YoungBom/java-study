...
public class Car {
	// 필드
	// 다형성을 활용하면, 어떤 타이어든 Tire를 상속 또는 구현하기만 하면됨
	// Car 클래스는 변경 없이 다양한 타이어를 수용할 수 있음
	// => 유지보수성과 확장성이 좋아짐
	Tire frontLeftTire = new Tire("앞왼쪽", 6); // 순정 타이어
	Tire frontRightTire = new Tire("앞오른쪽", 2); // 순정 타이어
	Tire backLeftTire = new Tire("뒷왼쪽", 3); // 순정 타이어
	Tire backRightTire = new Tire("뒷오른쪽", 4); // 순정 타이어
